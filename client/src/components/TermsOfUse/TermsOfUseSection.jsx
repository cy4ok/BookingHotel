  ...
  return (
    <div className="py-20 bg-gray-200">
      <div className="container">
        ...
        <h3>2. Назначение и область применения</h3>
        <p>
          <span>
        ...
        {TermsOfUseData.map((d, i) => (
          <ClientsListItem text={d.text} key={i} />
        ))}
        <p>
        ...
        <p>3.1.3. Отозвать согласие на обработку персональных данных.</p>
        <p>
        ...
        <p>
          ...
          <Link to="/policy">
            <p className="text-lg text-left text-brown">
