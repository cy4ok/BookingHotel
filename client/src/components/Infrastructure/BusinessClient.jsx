...
function BusinessClient() {
    return (
        <div className="business-client my-20 ml-12">
            <div className="text-white w-1/2 p-16">
                <h1 className="text-5xl mb-4">Бизнес-клиентам</h1>
                ...
                <div className="text-left mt-12 btn">
                    <Link to="/to-clients">
                        <span className="text-lg text-left btn">
