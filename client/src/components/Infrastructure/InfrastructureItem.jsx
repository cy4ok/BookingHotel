...
function InfrastructureItem() {
    return (
        <div className="flex flex-row ">
            ...
            <div className="w-1/2 p-2 mb-10 h-auto">
                <div className="bistro img"></div>
                <div className="text-2xl p-4">ATLAS Bistro</div>
                <div className="text-lg">Ресторан неофранцузской кухни</div>
            </div>
            <div className="w-1/2 p-2 mb-10 h-auto">
                <div className="parking"></div>
                <div className="text-2xl p-4">Подземный паркинг</div>
                <div className="text-lg">Просторный отапливаемый паркинг на 67 машиномест с доступом на этажи</div>
            </div>
        </div>
    );
};
