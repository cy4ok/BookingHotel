          ...
          <div className="flex justify-between pt-12 pb-8">
            <div className="flex flex-col justify-between">
              ...
              <div className="flex p-2 text-white">
                <div className="mr-4">
                  <a href="https://www.vk.com/" target="_blank" rel="noreferrer" className="btn--social hover:bg-bgBtn">
                    <FontAwesomeIcon icon={faVk} size="1x" className="social-icons icon-vk" />
                  </a>
                </div>
                <div className="mr-4">
                  <a href="https://www.facebook.com/" target="_blank" rel="noreferrer" className="btn--social hover:bg-bgBtn">
                    <FontAwesomeIcon icon={faFacebookF} size="1x" className="social-icons icon-fb"/>
                  </a>
                </div>
                <div>
                  <a href="https://www.instagram.com/" target="_blank" rel="noreferrer" className="btn--social hover:bg-bgBtn">
